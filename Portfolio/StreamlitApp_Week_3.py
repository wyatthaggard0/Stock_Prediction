...
MODEL_INFO = {
        ...
        "keys": ["RIVN", "TSLA", "LCID", "NIO" "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["RIVN", "TSLA","LCID", "NIO" "DEXJPUS", "DEXUSUK", "SP500", "DJIA", "VIXCLS"]]
}
